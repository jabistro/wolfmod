...
const V1_OVERRIDES: Record<string, Partial<Record<Theme, Art>>> = {
  ...
  Mason: {
    chibi: { image: require('../../roles_chibi_medium/mason.jpg'), thumb: require('../../roles_chibi_thumbs/mason.jpg') },
    '16bit': { image: require('../../roles_16bit_medium/mason.jpg'), thumb: require('../../roles_16bit_thumbs/mason.jpg') },
  },
  Werewolf: {
  ...
  Doppelganger: {
    chibi: { image: require('../../roles_chibi_medium/doppelganger.jpg'), thumb: require('../../roles_chibi_thumbs/doppelganger.jpg') },
    '16bit': { image: require('../../roles_16bit_medium/doppelganger.jpg'), thumb: require('../../roles_16bit_thumbs/doppelganger.jpg') },
  },
  Sasquatch: {
  ...
  Spawn: {
    chibi: { image: require('../../roles_chibi_medium/spawn.jpg'), thumb: require('../../roles_chibi_thumbs/spawn.jpg') },
    '16bit': { image: require('../../roles_16bit_medium/spawn.jpg'), thumb: require('../../roles_16bit_thumbs/spawn.jpg') },
  },
  Drunk: {
    chibi: { image: require('../../roles_chibi_medium/drunk.jpg'), thumb: require('../../roles_chibi_thumbs/drunk.jpg') },
    '16bit': { image: require('../../roles_16bit_medium/drunk.jpg'), thumb: require('../../roles_16bit_thumbs/drunk.jpg') },
  },
  'Nightmare Wolf': {
  ...
  'Mama Wolf': {
    chibi: { image: require('../../roles_chibi_medium/mama_wolf.jpg'), thumb: require('../../roles_chibi_thumbs/mama_wolf.jpg') },
    '16bit': { image: require('../../roles_16bit_medium/mama_wolf.jpg'), thumb: require('../../roles_16bit_thumbs/mama_wolf.jpg') },
  },
  'Alpha Wolf': {
    chibi: { image: require('../../roles_chibi_medium/alpha_wolf.jpg'), thumb: require('../../roles_chibi_thumbs/alpha_wolf.jpg') },
    '16bit': { image: require('../../roles_16bit_medium/alpha_wolf.jpg'), thumb: require('../../roles_16bit_thumbs/alpha_wolf.jpg') },
  },
};
